package com.platfrom.payment.common.utils;


import com.platfrom.payment.common.annotation.MybatisCriteriaAnnotation;
            ...
            if (annotation != null) {
                ...
                switch (annotation.method()) {
                    ...
                    /*
                      and equal
                     */
                    case MybatisCriteriaMethodEnum.AND_EQUAL_TO:
                        try {
                     ...
                     */
                    case MybatisCriteriaMethodEnum.AND_LIKE:
                        ...
                        break;
                    case MybatisCriteriaMethodEnum.AND_GREATER_THAN_OR_EQUAL_TO:
